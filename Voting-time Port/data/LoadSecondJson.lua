function onCreate()
    ...
    NewsCharacter={}
    CreateCharacter('jelqer','DAD',226-110, 232+160,'Opponent2')
    CreateCharacter('madgus',"DAD",1194+210, 192+430,'Player2')
...
function onCreatePost()
    ...
    for i=0,getProperty('unspawnNotes.length')-1 do
        if getPropertyFromGroup('unspawnNotes',i,'noteType')=='SecondJson' then
            ...
            if getPropertyFromGroup('unspawnNotes',i,'isSustainNote') and not stringEndsWith(getPropertyFromGroup('unspawnNotes',i,'animation.curAnim.name'),'tail')  then
