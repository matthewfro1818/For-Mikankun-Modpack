...
function onCreatePost()
    ...
    local Index={dad=nil,bf=nil,bf2=nil,dad2=nil}
    for i = 0, getProperty('unspawnNotes.length')-1 do
        local ActualStrum=GetUnSpawn( i, 'strumTime')
        if not GetUnSpawn( i, 'opponentSing')  then
            if LastNoteStrumBf2==ActualStrum and GetUnSpawn( i, 'noteType')=='SecondJson' then
            ...
            elseif LastNoteStrumBf==ActualStrum then
            ...
            if LastNoteStrumDad2==ActualStrum and GetUnSpawn( i, 'noteType')=='SecondJson' then
            ...
            elseif LastNoteStrumDad==ActualStrum then
        ...
        if not GetUnSpawn( i, 'opponentSing') then
            if GetUnSpawn( i, 'noteType')=='SecondJson' then
...
function GhostAnim(Character,SingAnim)
    ...
    if Character~='dad' or Character~='boyfriend' then
        setObjectOrder('Ghost'..Ghost,getObjectOrder(Character)-1)
    else
