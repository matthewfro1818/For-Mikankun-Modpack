...
function onCreatePost()
   ...
   addAnimationByPrefix('mattIdling', 'idle', 'matt idle', 24, true)
   ...
   addAnimationByPrefix('bfPunch', 'idle', 'BF idle dance', 24, true)
   ...
   makeLuaText('controls', 'Controls \nSpam SPACE to regain sheild \nPress Z once the stamina meter is full to gain a random power \nPress E to dodge', 1000, 140, 420)
