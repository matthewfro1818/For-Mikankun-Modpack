...
function onUpdate()   
   ...
   if keyboardJustPressed('E') and dodging == false and isStando == false and mustHitSection == false and isOra == false and prepareOra == false or keyboardJustPressed('E') and dodging == false and mattAttack == true then
      dodging = true
