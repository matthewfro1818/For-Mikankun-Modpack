...
sprite = 'stardustspeedway' --name of the image you want moving in the background
size = -3072 --number of pixels from left to right
startX = 0 --where you want it to be from left to right
startY = 262 --where you want it to be from bottom to top
...
setObjectOrder(sprite .. '1', getObjectOrder('dadGroup')+6)
setObjectOrder(sprite .. '2', getObjectOrder('dadGroup')+6)
scrollA()
end
...
function onStepHit()
	if curStep <= 894 and curStep >= 768 then
