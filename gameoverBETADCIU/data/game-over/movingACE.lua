...
sprite = 'loopAI' --name of the image you want moving in the background
size = -13668 --number of pixels from left to right
...
setObjectOrder(sprite .. '1', getObjectOrder('dadGroup')-0.1)
setObjectOrder(sprite .. '2', getObjectOrder('dadGroup')-0.1)
scrollA()
end
