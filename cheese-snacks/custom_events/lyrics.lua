function onCreate()
	makeLuaText('lyric','',screenWidth,0,screenHeight/1.3);
...
size = ssize:gsub(" ","")
	...
	if name == 'lyrics' then
		setProperty('lyric.y', screenHeight/1.3-size)
		--doTweenY('lyricmovething', 'lyric', screenHeight/1.3-size, 0.001 ,'linear')
