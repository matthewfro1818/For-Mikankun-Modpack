...
if noteType == 'bfbside_Sing' and noteData == 4 then

	objectPlayAnimation('bfbside', 'singUP',true);

end

if noteType == 'bfbside_Sing' and noteData == 5 then

	objectPlayAnimation('bfbside', 'singDOWN',true);

end

if noteType == 'bfbside_Sing' and noteData == 6 then

	objectPlayAnimation('bfbside', 'singLEFT',true);

end

if noteType == 'bfbside_Sing' and noteData == 7 then

	objectPlayAnimation('bfbside', 'singDOWN',true);

end

if noteType == 'bfbside_Sing' and noteData == 8 then

	objectPlayAnimation('bfbside', 'singUP',true);

end

if noteType == 'bfbside_Sing' and noteData == 9 then
