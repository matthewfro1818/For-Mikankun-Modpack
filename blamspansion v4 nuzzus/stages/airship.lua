...
function onCreate()
	...
	makeLuaSprite('cargo walls', 'cargowall', 250, 50);
	scaleLuaSprite('cargo walls', 1., 1.)
	addLuaSprite('cargo walls', false);
	setProperty('cargo walls.alpha', 0)

	makeLuaSprite('cargo', 'cargo', 50, 50);
	scaleLuaSprite('cargo', 1., 1.)
	addLuaSprite('cargo', false);
	setProperty('cargo.alpha', 0)

    makeLuaSprite('cargo walls2', 'iluminao omaga', 850, 450);
	scaleLuaSprite('cargo walls2', 1., 1.)
	addLuaSprite('cargo walls2', true);
	setProperty('cargo walls2.alpha', 1)

    setBlendMode('cargo walls2', 'add')
...
doTweenAlpha('blackboxfade', 'black', 0, 1, 'linear')
...
if curStep == 3408 then
    setProperty('cargo.alpha', 0)
    setProperty('cargo wall.alpha', 0)
    setProperty('dad.alpha', 0)
    setProperty('gf.alpha', 1)
    setProperty('overlay.alpha', 0.7)
    setProperty('f.alpha', 0)
