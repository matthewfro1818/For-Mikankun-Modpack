...
local swingTime = 4 -- 2 = normal, 2 = hell mode, can be higher if you want, dont make lower than 2 or an odd number will prob fuck it up
...
function onEvent(name, value1, value2)
	...
	if name == 'Enable Pendulum normal' then
		--debugPrint('hi') 
		active = true 
		reset();
		trance = 0
