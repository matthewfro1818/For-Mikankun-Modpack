function onCreate()
    ...
    precacheImage('whitebf')
    precacheImage('whitegreen')
end

function onEvent(name, v1, v2)

	
	if name == 'lights down' and v1 == 'on'then
			triggerEvent('Set Cam Zoom', '0.9', '')
			triggerEvent('Change Character', 'dad', 'greenlightsdown')
			triggerEvent('Change Character', 'bf', 'bflightsdown')
	...
	elseif name == 'lights down' and v1 == 'off' then
		triggerEvent('Flash Camera', '0.5', '')
