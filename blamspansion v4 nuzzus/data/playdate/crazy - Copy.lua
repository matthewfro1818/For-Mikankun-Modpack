...
--(its configured to be used on the test song)
    ...
    local charid = "testlolwhar5" --it doesn´t matter what you put in here, it just has to be different than any other charid of the scripts in the folder
    ...
    local charpos = {1040,100} --position of the character in the stage
                     --x,y
