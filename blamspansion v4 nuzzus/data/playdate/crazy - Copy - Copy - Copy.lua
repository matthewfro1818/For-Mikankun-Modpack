...
--(its configured to be used on the test song)
    ...
    local charid = "testlolwhar7" --it doesn´t matter what you put in here, it just has to be different than any other charid of the scripts in the folder

    local id = 4 --only numbers, and as charid, always different than any other id of the scripts in the folder
    ...
    local charorder = 12 --use this if you want your character to be behind something, i used 1000 but normally you dont need more than 20
    ...
    local charpos = {-1070,0} --position of the character in the stage
                     --x,y
