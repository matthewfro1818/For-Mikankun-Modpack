...
--(its configured to be used on the test song)
    ...
    local charid = "testlolwhar6" --it doesn´t matter what you put in here, it just has to be different than any other charid of the scripts in the folder

    local id = 3 --only numbers, and as charid, always different than any other id of the scripts in the folder
    ...
    local charimg = "Reginald_Assets" --use the image name from image/characters

    local charpath = "characters/" -- in case you want to use another path

    local charorder = 14 --use this if you want your character to be behind something, i used 1000 but normally you dont need more than 20
    ...
    local charpos = {1400,0} --position of the character in the stage
                     --x,y
    ...
    [2] = {"Left",24,false,100,0,"left"},                          --left

    [3] = {"Down",24,false,0, -50,"down"},                          --down

    [4] = {"Up",24,false,50,50,"up"},                               --up

    [5] = {"Right",24,false,0,-20,"right"},                         --right
