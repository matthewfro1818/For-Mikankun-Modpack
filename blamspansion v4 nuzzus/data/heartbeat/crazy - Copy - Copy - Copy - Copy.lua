...
--(its configured to be used on the test song)
    ...
    local charid = "testlolwhar8" --it doesn´t matter what you put in here, it just has to be different than any other charid of the scripts in the folder
    ...
    local charimg = "vines" --use the image name from image/characters

    local charpath = "pink/" -- in case you want to use another path

    local charorder = 52 --use this if you want your character to be behind something, i used 1000 but normally you dont need more than 20
    ...
    local charpos = {-970,-700} --position of the character in the stage
                     --x,y
