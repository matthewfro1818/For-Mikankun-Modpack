...
local Assets = { -- feel free to customize
    character = {
        ...
        idle = 'pink dies',
        loop = 'death loop',
        confirm = 'death confirm'
    },
    sounds = {
        loss = 'fnf_loss_sfx',
        music = 'gameover_v4_LOOP',
        confirm = 'gameover_v4_End'
    }
}
...
function onCustomSubstateCreate(tag)
	if tag == 'death' then
        ...
        makeAnimatedLuaSprite('dead', 'characters/'..Assets.character.name, defaultBoyfriendX + 0, defaultBoyfriendY + 150);
