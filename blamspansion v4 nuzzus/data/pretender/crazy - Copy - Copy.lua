...
--(its configured to be used on the test song)
    ...
    local charimg = "blued" --use the image name from image/characters
    ...
    local charpos = {-1050,300} --position of the character in the stage
                     --x,y
    ...
    [1] = {"bob bop",    24,          false,        0,          0,         "bob bop"},
