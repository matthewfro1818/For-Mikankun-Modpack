...
--(its configured to be used on the test song)
    ...
    local charimg = "BOYFRIEND" --use the image name from image/characters
    ...
    local charpos = {2600,300} --position of the character in the stage
                     --x,y
    ...
    [1] = {"BF idle dance",    24,          false,        0,          0,         "BF idle dance"},
