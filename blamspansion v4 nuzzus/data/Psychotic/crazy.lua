...
--(its configured to be used on the test song)
    ...
    local charid = "testlolwhar" --it doesn´t matter what you put in here, it just has to be different than any other charid of the scripts in the folder
    ...
    local charimg = "grayblack" --use the image name from image/characters
    ...
    local notename = "bf 1" --what notetype will the character sing 

    local cameraoffset = {0,0} --for the IC camera event

    local charpos = {-500,770} --position of the character in the stage
                     --x,y
    ...
    [1] = {"whoisthismf",    24,          false,        0,          0,         "whoisthismf"},
