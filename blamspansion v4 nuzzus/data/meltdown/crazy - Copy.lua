...
--(its configured to be used on the test song)
    ...
    local id = 5 --only numbers, and as charid, always different than any other id of the scripts in the folder
    ...
    local charimg = "boppers_meltdown" --use the image name from image/characters

    local charpath = "red/" -- in case you want to use another path

    local charorder = 19 --use this if you want your character to be behind something, i used 1000 but normally you dont need more than 20
    ...
    local charpos = {-600,100} --position of the character in the stage
                     --x,y
    ...
    [1] = {"BoppersMeltdown",    24,          false,        0,          0,         "BoppersMeltdown"},
