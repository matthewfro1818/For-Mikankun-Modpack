...
if noteType == 'bf' and noteData == 4 then

	objectPlayAnimation('bf', 'singUP',true);

end

if noteType == 'bf' and noteData == 5 then

	objectPlayAnimation('bf', 'singUP',true);

end

if noteType == 'bf' and noteData == 6 then

objectPlayAnimation('bf', 'singLEFT',true);

end

if noteType == 'bf' and noteData == 7 then

	objectPlayAnimation('bf', 'singDOWN',true);

end

if noteType == 'bf' and noteData == 8 then

	objectPlayAnimation('bf', 'singUP',true);

end

if noteType == 'bf' and noteData == 9 then
...
if noteType == 'allbf' and noteData == 0 then

	objectPlayAnimation('bf', 'singLEFT',true);

end

if noteType == 'allbf' and noteData == 1 then

	objectPlayAnimation('bf', 'singDOWN',true);

end

if noteType == 'allbf' and noteData == 2 then

	objectPlayAnimation('bf', 'singUP',true);

end

if noteType == 'allbf' and noteData == 3 then
