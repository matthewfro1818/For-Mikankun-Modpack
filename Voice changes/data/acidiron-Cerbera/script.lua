...
if curBeat >=320 and curBeat <= 514 then
	local currentBeat = (songPos/5000)*(curBpm/120)
doTweenY('bfmoves', 'boyfriend', 50 + 400*math.sin((currentBeat+1)*math.pi), 4)
doTweenX('bfmove', 'boyfriend', 670 + -200*math.sin((currentBeat+1)*math.pi), 4)
end
if curBeat >= 514 and curBeat <= 1991 then
	local currentBeat = (songPos/50000)*(curBpm/120)
doTweenY('bfmoves', 'boyfriend', 50 + -4000*math.sin((currentBeat+1)*math.pi), 4)
doTweenX('bfmove', 'boyfriend', 670 + -200*math.sin((currentBeat+1)*math.pi), 4)
