...
makeAnimatedLuaSprite('bfneo', 'characters/bfneo', 0, 0)
		...
		addAnimationByPrefix('bfneo', 'hey', 'BF HEY', 24, false) 

		addAnimationByPrefix('bfneo', 'hurt', 'BF hit', 24, false) 

		addAnimationByPrefix('bfneo', 'scared', 'BF idle shaking', 24, false) 

		addAnimationByPrefix('bfneo', 'dodge', 'boyfriend dodge', 24, false) 
...
function onUpdatePost(elapsed) -- This is the Offset Function 
			...
			elseif getProperty('bfneo.animation.curAnim.name') == 'hey' then
                setProperty('bfneo.offset.x',-3)
				setProperty('bfneo.offset.y',5)
              
			
			elseif getProperty('bfneo.animation.curAnim.name') == 'scared' then
                setProperty('bfneo.offset.x',-4)
				setProperty('bfneo.offset.y',0)
              
			elseif getProperty('bfneo.animation.curAnim.name') == 'hrut' then
                setProperty('bfneo.offset.x',15)
				setProperty('bfneo.offset.y',18)
              
			elseif getProperty('bfneo.animation.curAnim.name') == 'dodge' then
                setProperty('bfneo.offset.x',-10)
				setProperty('bfneo.offset.y',-16)
...
if noteType == 'hank_bfneo' and noteData == 0 then

	objectPlayAnimation('bfneo', 'singLEFT',true);

end

if noteType == 'hank_bfneo' and noteData == 1 then

	objectPlayAnimation('bfneo', 'singDOWN',true);

end

if noteType == 'hank_bfneo' and noteData == 2 then

	objectPlayAnimation('bfneo', 'singUP',true);

end

if noteType == 'hank_bfneo' and noteData == 3 then
