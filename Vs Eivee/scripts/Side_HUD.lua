...
function onCreate()
    ...
    makeLuaText("sick", 'Cool!: 0', 200, getProperty('cm.x'), getProperty('cm.y') + 30);
    makeLuaText("good", 'Good: 0', 200, getProperty('cm.x'), getProperty('sick.y') + 30);
    makeLuaText("bad", 'Um..: 0', 200, getProperty('cm.x'), getProperty('good.y') + 30);
    makeLuaText("shit", 'Oh...: 0', 200, getProperty('cm.x'), getProperty('bad.y') + 30);
...
function onUpdate(elapsed)
    ...
    setTextString('sick', 'Cool!: ' .. getProperty('sicks'))
    setTextString('good', 'Goods: ' .. getProperty('goods'))
    setTextString('bad', 'Um..: ' .. getProperty('bads'))
    setTextString('shit', 'Oh...: ' .. getProperty('shits'))
