...
isStoryMode = false
function onCreate()
         makeLuaSprite('win', 'achievements/slowyfire', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'Its bruning', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'Clear the bruning with FC', 200, 120, 40) -- change your description text
