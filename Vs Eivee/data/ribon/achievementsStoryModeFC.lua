...
isStoryMode = false
function onCreate()
         makeLuaSprite('win', 'achievements/ribon', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'The ribbon.', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'Clear the ribon with FC', 200, 120, 40) -- change your description text
