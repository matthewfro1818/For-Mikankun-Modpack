...
isStoryMode = false
function onCreate()
         makeLuaSprite('win', 'achievements/darkness', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'So Darkness', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'Clear the darkness with FC', 200, 120, 40) -- change your description text
