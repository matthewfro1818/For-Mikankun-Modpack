...
isStoryMode = false
function onCreate()
         makeLuaSprite('win', 'achievements/lightning', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'clap of thunder.', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'Clear the lightning with FC', 200, 120, 40) -- change your description text
