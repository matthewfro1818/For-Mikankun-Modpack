...
isStoryMode = false
function onCreate()
         makeLuaSprite('win', 'achievements/snowy', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'Its snowing.', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'Clear the snowy mountain with FC', 200, 120, 40) -- change your description text
