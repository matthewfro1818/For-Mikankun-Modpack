...
function onCreate()
         makeLuaSprite('win', 'achievements/devilsgambitFC', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'How????', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'Clear the davils gambit with FC', 200, 120, 40) -- change your description text
