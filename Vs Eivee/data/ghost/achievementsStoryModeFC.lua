...
isStoryMode = false
function onCreate()
         makeLuaSprite('win', 'achievements/ghost', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'Purple Ghost', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'Clear the ghost with FC', 200, 120, 40) -- change your description text
