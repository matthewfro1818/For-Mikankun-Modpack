...
isStoryMode = false
function onCreate()
         makeLuaSprite('win', 'achievements/fakedoll', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'ERROR 404', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', '@@#^*!\*_++_=``~@', 200, 120, 40) -- change your description text
