...
isStoryMode = false
function onCreate()
         makeLuaSprite('win', 'achievements/flying', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'Lets fly in the sky!', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'Clear the flying with FC', 200, 120, 40) -- change your description text
