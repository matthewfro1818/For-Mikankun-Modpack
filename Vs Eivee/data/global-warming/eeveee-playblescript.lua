...
idleoffsets = {'130', '-160'} -- I recommend you have your idle offset at 0
leftoffsets = {'123', '-173'}
downoffsets = {'159', '-193'}
upoffsets = {'125', '-172'}
rightoffsets = {'126', '-167'}

-- change all of these to the name of the animation in your character's xml file
idle_xml_name = 'eeveee-playble idle'
left_xml_name = 'eeveee-playble right'
down_xml_name = 'eeveee-playble down'
up_xml_name = 'eeveee-playble up'
right_xml_name = 'eeveee-playble left'
...
name_of_character_xml = 'eeveee-playble'
name_of_character = 'eeveee-playble'
name_of_notetype = 'eeveee-playble'
name_of_notetype2 = 'doublesing'
