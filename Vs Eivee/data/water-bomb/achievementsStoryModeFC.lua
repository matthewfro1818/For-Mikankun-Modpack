...
isStoryMode = false
function onCreate()
         makeLuaSprite('win', 'achievements/waterbomb', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'boom!!', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'Clear the water bomb with FC', 200, 120, 40) -- change your description text
