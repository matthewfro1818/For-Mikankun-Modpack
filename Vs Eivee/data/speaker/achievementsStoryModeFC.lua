...
isStoryMode = false
function onCreate()
         makeLuaSprite('win', 'achievements/speaker', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'Its so loud!', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'Clear the speaker with FC', 200, 120, 40) -- change your description text
