...
isStoryMode = false
function onCreate()
         makeLuaSprite('win', 'achievements/changed', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'He cant beat you.', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'Clear the changed with FC', 200, 120, 40) -- change your description text
