...
isStoryMode = false
function onCreate()
         makeLuaSprite('win', 'achievements/magical', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'Where are you going?', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'Clear the magical with FC', 200, 120, 40) -- change your description text
