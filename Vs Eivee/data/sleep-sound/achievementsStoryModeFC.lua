...
isStoryMode = false
function onCreate()
         makeLuaSprite('win', 'achievements/sleep', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'good night..', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'Clear the sleep sound with FC', 200, 120, 40) -- change your description text
