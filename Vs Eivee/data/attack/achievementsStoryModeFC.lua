...
isStoryMode = false
function onCreate()
         makeLuaSprite('win', 'achievements/attack', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'Thats the end of the prank!', 200, 120, 10) -- change your title text
         ...
         makeLuaText('text2', 'Clear the this with FC', 200, 120, 40) -- change your description text
