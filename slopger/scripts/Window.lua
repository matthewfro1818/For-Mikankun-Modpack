...
local Name = "Friday Night Funkin' | VS. Slopger" -- Window Name
local FNF = false -- Puts (Friday Night Funkin' | VS. Slopger) Before Window Name
...
function onDestroy()
   ...
   songended = true
    setPropertyFromClass('lime.app.Application', 'current.window.title', "Friday Night Funkin' | VS. Slopger")
